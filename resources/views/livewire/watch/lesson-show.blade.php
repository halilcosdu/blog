<div>
    ...
    $wire.on('lesson-completed', (...args) => {
        console.log('Lesson completed event args:', args);
        
        // Livewire v3 named parameters handling
        let message = 'Lesson completed! 🎉';
        
        if (args.length >= 1) {
            if (typeof args[0] === 'string') {
                message = args[0];
            } else if (typeof args[0] === 'object' && args[0].message) {
    ...
    $wire.on('comment-posted', (...args) => {
        console.log('Comment event args:', args);
        
        // Livewire v3 named parameters handling
        let message = 'Comment action completed';
    ...
    <script>
        ...
        document.getElementById('deleteModal').addEventListener('click', function(e) {
            // Modal content has stopPropagation, so this only triggers on backdrop
            hideDeleteModal();
        });
