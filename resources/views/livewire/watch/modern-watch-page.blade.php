    ...
    <main class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
                ...
                <a href="{{ $pathway['url'] }}" class="group bg-white dark:bg-slate-900 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-slate-200 dark:border-slate-700 hover:-translate-y-1 cursor-pointer block">
                    {{-- Pathway Header --}}
                    <div class="relative">
                        <div class="aspect-video bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 relative overflow-hidden">
                            ...
                            @else
                                ...
                                <div class="absolute inset-0 overflow-hidden">
                                    ...
                                    <div class="absolute inset-0 opacity-10">
                                        <div class="absolute top-3 left-3 w-6 h-6 bg-indigo-400 rounded-full animate-pulse"></div>
                                        <div class="absolute top-8 right-6 w-4 h-4 bg-purple-400 rounded-full animate-pulse" style="animation-delay: 0.5s"></div>
                                        <div class="absolute bottom-6 left-8 w-3 h-3 bg-blue-400 rounded-full animate-pulse" style="animation-delay: 1s"></div>
                                        <div class="absolute bottom-12 right-4 w-5 h-5 bg-teal-400 rounded-full animate-pulse" style="animation-delay: 1.5s"></div>
                                    </div>
                                    ...
                                    <div class="absolute inset-0 flex items-center justify-center">
                                        <div class="text-center text-white">
                                            {{-- Pathway Icon --}}
                                            <div class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-2 shadow-lg">
                                            ...
                                            {{-- Pathway Info --}}
                                            <p class="text-xs opacity-75">{{ $pathway['lessons'] }} Learning Items</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="absolute top-3 left-3">
                                <div class="inline-flex items-center px-2 py-1 bg-indigo-600/90 backdrop-blur-sm text-indigo-100 rounded-full text-xs font-medium border border-indigo-500/30">
                            ...
                            <div class="absolute inset-0 flex items-center justify-center">
                                <div class="w-14 h-14 bg-indigo-600/90 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 scale-75 group-hover:scale-100 hover:bg-indigo-700">
                    ...
                    <div class="p-5">
                        ...
                        <div class="mb-4">
                            <h3 class="text-lg font-bold text-slate-900 dark:text-white mb-2 group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors line-clamp-2">
                                {{ $pathway['title'] }}
                            </h3>
                        ...
                        <div class="flex items-center justify-between mb-4 text-sm">
                            <div class="flex items-center gap-4 text-slate-600 dark:text-slate-400">
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="font-medium">{{ $pathway['lessons'] }}</span>
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="font-medium">{{ $pathway['duration'] }}</span>
                                </div>
                            </div>
                            
                            {{-- Level Badge --}}
                            <span class="px-2 py-1 bg-slate-100 dark:bg-slate-800 rounded-full text-xs font-medium text-slate-700 dark:text-slate-300 capitalize">
                                {{ $pathway['level'] }}
                            </span>
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-3 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="flex items-center gap-2">
                                @if($pathway['category'])
                                <span class="px-2 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 rounded-full text-xs font-medium">
                                    {{ $pathway['category'] }}
                                </span>
                                @endif
                            </div>
                            ...
                            <div class="flex items-center gap-1 text-slate-500 dark:text-slate-400 text-xs">
                                ...
                                <span>{{ number_format($pathway['students']) }}</span>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 pt-3 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                                <div class="bg-green-500 h-2 rounded-full transition-all duration-300" style="width: {{ $pathway['progress'] }}%"></div>
                            </div>
                        </div>
                        @endif
